...
lifecycle enrichment and embedded CycloneDX VEX statements are captured for
exploitability context. Failed uploads remain in the repair workspace and are
not lifecycle/VEX-enriched as trusted components until import succeeds.
