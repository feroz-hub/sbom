            ...
            <table className="min-w-full text-sm">
              <thead className="bg-surface-elevated">
                <tr>
                  ...
                  <th className="px-4 py-2 text-left font-medium">Legacy external mapping</th>
              ...
              <tbody>
                {tenants.data.map((tenant) => (
                  <tr key={tenant.id} className="border-t border-border">
                    ...
                    <td className="px-4 py-3 font-mono text-xs text-hcl-muted">
                      {tenant.external_iam_tenant_id || 'Not configured'}
                    </td>
