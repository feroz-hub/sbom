        ...
        <div className="absolute left-0 right-0 top-full mt-1 z-50 max-h-64 overflow-y-auto rounded-xl border border-border bg-surface shadow-elev-3 p-1">
          ...
          {results.map((user) => (
            <button
              ...
              className="flex w-full items-start justify-between rounded-lg p-2.5 text-left text-sm hover:bg-surface-muted transition-colors border-b border-border/30 last:border-0"
            >
