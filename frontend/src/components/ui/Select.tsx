      ...
      <div className="flex flex-col gap-1.5">
        ...
        <div className="relative">
          <select
            ...
            id={inputId}
            className={cn(
              'w-full appearance-none rounded-lg border px-3 py-2 pr-8 text-sm text-slate-900',
          ...
          <ChevronDown className="absolute right-2.5 top-1/2 -translate-y-1/2 h-4 w-4 text-hcl-muted pointer-events-none" />
        </div>
