...
const STATUS_STYLES: Record<AnalysisStatus, string> = {
  ...
  PASS: 'border-green-200 bg-green-50 text-green-700 dark:border-emerald-800 dark:bg-emerald-950/50 dark:text-emerald-200',
  FAIL: 'border-red-200 bg-red-50 text-red-700 dark:border-red-800 dark:bg-red-950/50 dark:text-red-200',
