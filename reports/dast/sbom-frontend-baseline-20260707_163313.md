...
| Info | Informational | http://host.docker.internal:3000 | Percentage of responses with status code 2xx | 68 % |
| Info | Informational | http://host.docker.internal:3000 | Percentage of responses with status code 3xx | 28 % |
| Info | Informational | http://host.docker.internal:3000 | Percentage of responses with status code 4xx | 2 % |
...
| Info | Informational | http://host.docker.internal:3000 | Percentage of slow responses | 46 % |
...
| Information Disclosure - Suspicious Comments | Informational | 35 |
...
* URL: http://host.docker.internal:3000/_next/static/chunks/node_modules_recharts_es6_chart_1f_ue5b._.js
  * Node Name: `http://host.docker.internal:3000/_next/static/chunks/node_modules_recharts_es6_chart_1f_ue5b._.js`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `// TODO need to verify data`
  * Other Info: `The following pattern was used: \bTODO\b and was detected 3 times, the first in likely comment: "// TODO need to verify dataKey", see evidence field for the suspicious comment/snippet.`
* URL: http://host.docker.internal:3000/_next/static/chunks/node_modules_recharts_es6_chart_1f_ue5b._.js
  * Node Name: `http://host.docker.internal:3000/_next/static/chunks/node_modules_recharts_es6_chart_1f_ue5b._.js`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `rt names, read size from DOM once`
  * Other Info: `The following pattern was used: \bFROM\b and was detected 4 times, the first in likely comment: "// When width or height are percentages or CSS short names, read size from DOM once", see evidence field for the suspicious comment/snippet.`
* URL: http://host.docker.internal:3000/_next/static/chunks/node_modules_recharts_es6_chart_1f_ue5b._.js
  * Node Name: `http://host.docker.internal:3000/_next/static/chunks/node_modules_recharts_es6_chart_1f_ue5b._.js`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `t which element the user is touching
   * ou`
  * Other Info: `The following pattern was used: \bUSER\b and was detected in likely comment: "/*
   * onTouchMove is special because it behaves different from mouse events.
   * Mouse events have 'enter' + 'leave' combo th", see evidence field for the suspicious comment/snippet.`
