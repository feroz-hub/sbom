...
ROLE_PERMISSIONS: dict[str, frozenset[str]] = {
    ...
    "SECURITY_ANALYST": frozenset(
        {
            "sbom:read", "sbom:upload", "sbom:update", "sbom:export",
            "project:read", "project:create", "project:update",
            "component:read", "component:update",
            "lifecycle:read", "lifecycle:override", "vex:read", "vex:write",
            "remediation:read", "remediation:write", "remediation:close",
            "dashboard:read", "schedule:read", "schedule:write",
            "analysis:read", "analysis:run",
        }
    ),
    "DEVELOPER": frozenset(
        {
            "sbom:read", "project:read", "component:read", "lifecycle:read",
            "vex:read", "remediation:read", "remediation:write",
            "dashboard:read", "schedule:read", "analysis:read",
        }
    ),
    "VIEWER": frozenset(
        {
            "sbom:read", "project:read", "component:read", "lifecycle:read",
            "vex:read", "remediation:read", "dashboard:read", "schedule:read",
            "analysis:read",
        }
    ),
}
